...
export default function PlatformsIndex({ projects }) {
  return (
    <>
      <Head>
        <title>Platforms - Daniel Butler</title>
        <meta
          name="description"
          content="Projects that create an ecosystem."
        />
      </Head>
      <SimpleLayout
        title="Projects that create an ecosystem."
        intro="Some of the projects I've worked on encapsulated an entire existence of tools and solutions."
      >
        <ul
          role="list"
