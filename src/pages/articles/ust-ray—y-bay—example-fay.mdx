...
This is a part of the series going through the [rust book](https://doc.rust-lang.org/stable/book/ch08-03-hash-maps.html#summary). I'm most comfortable with python code, so I've sketched out the program to be written in rust with python first. It help iron out any misunderstandings I may have. 
