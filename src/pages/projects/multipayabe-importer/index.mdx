...
The time savings is roughly 8¼ hours per month considering 7 minutes would be spent entering each of the rents into the accounting system and the time required to manage the recurring journal entry.
